...
"    }
",
"    function keepTracerAndPopupInView() {
",
"      if (!tracer) return;
",
"      map.panInside(tracer.getLatLng(), {
",
...
"    var idx = 1;
",
"    var segDurationMs = Math.max(14, Math.floor((partMs / pointsPerPart) * 0.55));
",
"
",
