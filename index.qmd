...
m <- leaflet(
  ...
  addPolygons(
    ...
    label = ~paste(
      ...
      CNTY_NM,
      "County providing birth control in 2023."
    ),
    labelOptions = labelOptions(
      direction = "auto",
      textsize = "14px",
...
| In 2025, they served [2,576 patients]{#cr-t8} [@mobile_clientsserved_2025] across [15,000 square miles]{#cr-t9} of Texas using its mobile unit.^[Area represents the combined land area of the 18 counties served by the mobile unit in 2025 and is intended to approximate the geographic service area.]
