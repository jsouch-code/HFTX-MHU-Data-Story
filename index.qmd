...
| Across Texas, [1.75 million women]{#cr-t5}
| in need live in contraceptive deserts, where access
| to affordable birth control is limited or nonexistent.
| In Texas, [153,040 women]{#cr-t6} live in counties
| without a single health center offering
| a full range of birth control methods.
| Together, these gaps in maternal and women’s
| healthcare make timely,
...
| **Voices of Patients:**,
| 
| “I got scared after my neighbor died of breast cancer. She came to me one day and showed me her left breast.
| I told her she needed to go to a doctor, but it was too late. She suffered for a year and died of breast cancer, because she
| [couldn’t find the right medical services]{#cr-t1}. I then decided I needed to find a way to live for my family.When I discovered your clinic and 
| learned about the services you all provide, [I found hope again]{#cr-t2}. I feel that my health is important to my family, 
| because without me, I don’t know how they would be able to take care of themselves.”
...
m <- leaflet(width = "99vw", height = "99vh", options = leafletOptions(zoomControl = FALSE, scrollWheelZoom = FALSE)) %>%
  addPolygons(
    data = texas_map,
...
::: {.cr-section .emphasis-section layout="overlay-center"}
@cr-myimage-capitol
During the 89th Legislative Session, the Texas Women’s Healthcare Coalition and its partners secured [\$20 million]{.key-number1} in new state funding to expand mobile women's health units across Texas, doubling down on a commitment to meet women where they are. 
