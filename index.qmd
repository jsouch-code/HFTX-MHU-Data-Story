...
m <- leaflet(width = "99vw", height = "99vh", options = leafletOptions(zoomControl = FALSE, scrollWheelZoom = FALSE, minZoom = 5)) %>%
  addPolygons(
    data = texas_map,
...
",
"  var mobileIconScale = isMobileViewport ? Math.max(0.82, Math.min(0.94, window.innerWidth / 460)) : 1;
",
...
",
"    map.setMaxBounds(serviceBounds.pad(0.02));
",
"    map.options.maxBoundsViscosity = 1.0;
",
"    map.setMinZoom(fullServiceZoom);
",
"    map.setMaxZoom(fullServiceZoom);
",
"    map.setView(mobileCenter, fullServiceZoom, { animate: false });
",
"  } else {
",
