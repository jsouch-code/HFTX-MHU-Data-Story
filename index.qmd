...
texas_map <- st_read(params$population_geojson, quiet=TRUE) |> 
  st_transform(4326) |>
  ms_simplify(keep = 0.05, keep_shapes = TRUE)

providers <- st_read(params$provider_geojson, quiet=TRUE) |>
  st_transform(4326)
...
m <- leaflet(
  ...
  addPolygons(
    ...
    label = ~paste(
      ...
      CNTY_NM,
      "County in", params$report_year, "with 10 new birth control prescriptions per 1,000 women of reproductive age."
    ),
    labelOptions = labelOptions(
      direction = "auto",
      textsize = "14px",
