...
# The geography of healthcare. <span class="info-icon" tabindex="0" role="button" aria-label="How to explore this story">i<span class="info-popup"><strong>How to explore this story</strong><ul><li>Scroll to move through the narrative.</li><li>Hover over maps and charts for details.</li><li>Click interactive elements to filter data.</li><li>Use fullscreen mode on maps for deeper exploration.</li></ul><div class="popup-note">Best viewed on desktop or tablet.</div></span></span>
...
.info-popup {
  ...
  box-shadow: 0 12px 28px rgba(32, 16, 30, 0.2);
  color: #2e1e2c;
  font-size: 0.98rem;
  line-height: 1.45;
  text-align: left;
