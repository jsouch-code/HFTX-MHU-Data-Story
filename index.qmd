...
"  }
",
"  function isVanVisible() {
",
"    if (!tracer) return false;
",
"    return map.getBounds().contains(tracer.getLatLng());
",
"  }
",
"  function shouldFollowVan() {
",
"    return tracer && map.getZoom() > (fullServiceZoom + 0.5) && isVanVisible();
",
"  }
",
...
",
"    followVanWhenZoomed = shouldFollowVan();
",
"    if (!followVanWhenZoomed && !isServiceAreaInView()) {
",
"      refitServiceArea();
",
"    }
...
",
"    var syncMobileFollowState = function() { followVanWhenZoomed = shouldFollowVan(); };
",
"    map.on('zoomend moveend', syncMobileFollowState);
",
"    syncMobileFollowState();
",
"  } else {
",
