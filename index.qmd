...
::: {.cr-section .emphasis-section layout="overlay-left"}
::: progress-block
...
| Barriers to care extend beyond pregnancy.
| Across Texas, [1.75 million women]{#cr-t5} in need live in contraceptive deserts, where access to
| affordable birth control is limited or nonexistent. In Texas, [153,040 women]{#cr-t6} live in counties
| without a single health center offering a full range of birth control methods.
| Together, these gaps in maternal and women’s healthcare make timely,
| comprehensive care out of reach for many, underscoring the urgent need for solutions
...
### Introduction to Mobile Clinics
...
| **One patient told a Texas mobile clinic provider**, “I got scared after my neighbor
| died of breast cancer. She came to me one day and showed me her left breast.
| I told her she needed to go to a doctor, but it was too late.
| She suffered for a year and died of breast cancer, because she [couldn’t find the right medical services]{#cr-t1}.
| I then decided I needed to find a way to live for my family.When I discovered your clinic and learned
| about the services you all provide, [I found hope again]{#cr-t2}.  I feel that my health is important to my family, because
| without me, I don’t know how they would be able to take care of themselves.”
...
df |>
  e_charts(sex, height = "800px", width = "800px") |>
  e_pie(
    value,
    radius = c("0%", "55%"),
    center = c("50%", "58%"),
...
| "Now we're able to do a [full clinic]{#cr-t1},
| just like a brick-and-mortar clinic, [just on wheels]{#cr-t2}."
